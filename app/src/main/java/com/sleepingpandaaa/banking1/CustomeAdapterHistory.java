...
public class CustomeAdapterHistory extends RecyclerView.Adapter<ViewHolder> {
    ...
    com.sleepingpandaaa.banking1.HistoryList HistoryList;
    List<Model> modelList;
    Context context;

    TextView mTransc_status;

    public CustomeAdapterHistory(com.sleepingpandaaa.banking1.HistoryList historyList, List<Model> modelList) {
