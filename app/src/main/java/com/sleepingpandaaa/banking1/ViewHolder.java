...
public class ViewHolder extends RecyclerView.ViewHolder {
    ...
    private com.sleepingpandaaa.banking1.ViewHolder.ClickListener mClickListener;
    public interface  ClickListener{
        void onItemClick(View view, int position);
    }

    public void setOnClickListener(com.sleepingpandaaa.banking1.ViewHolder.ClickListener clickListener){
